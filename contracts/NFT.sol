...
contract NFT is ERC721MintMore, Ownable {
  ...
  function transfer(address _fromAddress, address _toAddress, uint256 _nftID) public {
  ...
  function nftLevelUpgrade(uint256 _nftID, uint256 _levels) public {
    ...
    uint256 amount = _levels * collections[nfts[_nftID].collectionID].tokenUpgradePriceLevel;
  ...
  function nftSetProperty(uint256 _nftID, uint256 _propertyID, uint256 _value) public {
    ...
    uint256 amount = collections[nfts[_nftID].collectionID].tokenUpgradePriceSetProperty;
  ...
  function getTokenProductToHarvest(uint256 _nftID) public view returns (uint256) {
  ...
  function mint(address _recipient, uint256 _collectionID, string memory _name, bool _hasParents, uint256 _parentMaleID, uint256 _parentFemaleID) public onlyOwner returns (uint256) {
  ...
  function mintMore(address _recipient, uint256 _collectionID, string memory _name, uint256 _count) public onlyOwner returns (uint256) {
    ...
    for (uint256 i = 0; i < _count; i++) mintAddDetails(_collectionID, string(abi.encodePacked(_name, " ", Strings.toString(nftCount + 1))), false, 0, 0);
    return nftCount - 1;
  }

  function mintToMarketplace(uint256 _collectionID, string memory _name, uint256 _price) public onlyOwner {
  ...
  function mintMoreToMarketplace(uint256 _collectionID, string memory _name, uint256 _price, uint256 _count) public onlyOwner {
    uint256 startID = nftCount;
    mintMore(address(this), _collectionID, _name, _count);
    for (uint256 i = 0; i < _count; i++) marketplace.deposit(address(this), startID + i, _price);
  }

  function mintAddDetails(uint256 _collectionID, string memory _name, bool _hasParents, uint256 _parentMaleID, uint256 _parentFemaleID) private onlyOwner {
  ...
  function factory(uint256 _nftMaleID, uint256 _nftFemaleID, string memory _name) public {
    ...
    uint256 newID = mint(msg.sender, nfts[_nftMaleID].collectionID, _name, true, _nftMaleID, _nftFemaleID);
    emit eventFactory(_nftMaleID, _nftFemaleID, newID);
  }

  function getNFTProperty(uint256 _nftID, uint256 _propertyID) public view returns (uint256) {
  ...
  function getCollectionProperty(uint256 _collectionID, uint256 _propertyID) public view returns (Property memory) {
  ...
  function collectionAdd(string memory _name, uint256 _factoryTime, uint256 _tokenProductEmission, uint256 _tokenUpgradePriceLevel, uint256 _tokenUpgradePriceSetProperty, uint256 _tokenFactoryPrice) public onlyOwner returns (uint256) {
  ...
  function collectionRename(uint256 _collectionID, string memory _name) public onlyOwner {
  ...
  function collectionSetFactoryTime(uint256 _collectionID, uint256 _factoryTime) public onlyOwner {
  ...
  function collectionSetTokenProductEmission(uint256 _collectionID, uint256 _emission) public onlyOwner {
  ...
  function collectionSetTokenUpgradePriceLevel(uint256 _collectionID, uint256 _price) public onlyOwner {
  ...
  function collectionSetTokenUpgradePriceSetProperty(uint256 _collectionID, uint256 _price) public onlyOwner {
  ...
  function collectionSetTokenFactoryPrice(uint256 _collectionID, uint256 _price) public onlyOwner {
  ...
  function collectionPropertyAdd(uint256 _collectionID, string memory _name, uint256 _basicCount) public onlyOwner {
  ...
  function collectionPropertyRename(uint256 _collectionID, uint256 _propertyID, string memory _name) public onlyOwner {
  ...
  function collectionPropertySetBasicCount(uint256 _collectionID, uint256 _propertyID, uint256 _basicCount) public onlyOwner {
  ...
  function collectionPropertyRemove(uint256 _collectionID, uint256 _propertyID) public onlyOwner {
  ...
  function getRandomNumber(uint256 _num) private returns (uint256) {
    ...
    return uint256(uint256(keccak256(abi.encodePacked(block.timestamp, rndCounter))) % _num);
  }
